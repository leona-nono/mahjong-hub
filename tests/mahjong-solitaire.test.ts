...
describe('solitaire tiles + art keys', () => {
  ...
  it('maps art keys without 万 character filenames', () => {
    ...
    expect(tileArtSrc('m5')).toBe('/assets/mahjong-solitaire/tiles/man-05.png?v=20260917');
    expect(tileArtSrc('z7')).toBe('/assets/mahjong-solitaire/tiles/dragon-red.png?v=20260917');
    expect(tileArtSrc('f1')).toBe('/assets/mahjong-solitaire/tiles/season-spring.svg?v=20260917');
  });
